...
// These are copied from above ASM defines. Can we have a single definition that covers both?
#define MAXARGS 16   /* max. amount of arguments in arg. table */
#define CL_SIZE 64   /* command line buffer size           */

__export __ma int __argc = 0;
__export char __argv[MAXARGS * 2 + 1];
__export char __cl_buffer[CL_SIZE + 1];
